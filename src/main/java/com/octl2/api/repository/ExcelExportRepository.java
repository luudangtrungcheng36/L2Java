...
@Repository
public interface ExcelExportRepository extends JpaRepository<Province, Long> {
        @Query(value = "SELECT " +
        ...
        List<ExcelExportProjection> findLogisticsLevel1(
        ...
        @Query(value = "SELECT " +
                        ...
                        "WHERE p.org_id = :orgId " +
                        "ORDER BY p.province_id", nativeQuery = true)
        List<ExcelExportProjection> findLogisticsLevel2(
                        @Param("orgId") Integer orgId);
        ...
        @Query(value = "SELECT " +
                        ...
                        "WHERE p.org_id = :orgId " +
                        "ORDER BY p.province_id", nativeQuery = true)
        List<ExcelExportProjection> findLogisticsLevel3(
                        @Param("orgId") Integer orgId);
}
